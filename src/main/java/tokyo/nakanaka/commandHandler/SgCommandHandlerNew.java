...
public class SgCommandHandlerNew {
	...
	public SgCommandHandlerNew(BlockCommandArgument blockArg) {
		...
		this.subList.add(new SelCommandHandler(strategyMap));
		this.subList.add(new ShapeCommandHandler(strategyMap));
		this.subList.add(new GenrCommandHandler(blockArg, strategyMap));
