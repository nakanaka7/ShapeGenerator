...
public class TetrahedronSelection {
	...
	public static Map<String, SubCommandHandler> selSubCommandHandlerMap(){
		...
		map.put(POS1, new PosCommandHandler(POS1, TetrahedronSelection::newSelectionData));
		map.put(POS2, new PosCommandHandler(POS2, TetrahedronSelection::newSelectionData));
		map.put(POS3, new PosCommandHandler(POS3, TetrahedronSelection::newSelectionData));
		map.put(POS4, new PosCommandHandler(POS4, TetrahedronSelection::newSelectionData));
		return map;
	}
