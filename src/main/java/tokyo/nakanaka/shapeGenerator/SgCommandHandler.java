...
public class SgCommandHandler {
	...
	private static void onRecursiveCommand(String[] parentLabels, CommandEntry cmdEntry, UserData user, String[] args) {
	...
	private List<String> onRecursiveTabComplete(CommandEntry cmdEntry, UserData user, String[] args) {
		if(args.length == 0) {
