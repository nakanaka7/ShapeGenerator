...
public class TriangleSelection {
	...
	public static Map<String, SubCommandHandler> selSubCommandHandlerMap() {
		...
		map.put(POS1, new PosCommandHandler(POS1, TriangleSelection::newSelectionData));
		map.put(POS2, new PosCommandHandler(POS2, TriangleSelection::newSelectionData));
		map.put(POS3, new PosCommandHandler(POS3, TriangleSelection::newSelectionData));
		map.put(THICKNESS, new LengthCommandHandler(THICKNESS, TriangleSelection::newSelectionData));
		return map;
	}
